...
export default function ConsultingServices() {
  ...
  const filtered = services.filter((s) => consultingServiceIds.includes(s.id));
  ...
  return (
    <>
      <section className="relative pt-32 pb-28 md:pt-40 md:pb-36 overflow-hidden bg-brand-navy">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-brand-navy/90 via-brand-navy to-emerald-900/30" />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }} className="max-w-3xl">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-xs font-semibold tracking-[0.18em] uppercase text-emerald-400">Consulting</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-white/60 leading-relaxed mt-6 max-w-2xl">
              Training, certification, and advisory services that empower professionals and organizations.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-brand-navy mt-3">Empowering Professionals &amp; Organizations</h2>
            <p className="text-text-secondary mt-4 max-w-xl">Expert training, certification, and advisory to accelerate careers and transform businesses.</p>
          </motion.div>
